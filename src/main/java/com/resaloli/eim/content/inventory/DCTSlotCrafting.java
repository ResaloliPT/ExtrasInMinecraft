...
public class DCTSlotCrafting extends Slot
{
    /** The craft matrix inventory linked to this result slot. */
    private final DCTCrafting craftMatrix;
    /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer player;
    /** The number of items that have been crafted so far. Gets passed to ItemStack.onCrafting before being reset. */
    private int amountCrafted;

    public DCTSlotCrafting(EntityPlayer player, DCTCrafting craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        InventoryCraftingResult inventorycraftresult = (InventoryCraftingResult)this.inventory;
    ...
    public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
    {
        ...
        NonNullList<ItemStack> nonnulllist = CraftingManagerDCT.getRemainingItems(this.craftMatrix, thePlayer.world);
