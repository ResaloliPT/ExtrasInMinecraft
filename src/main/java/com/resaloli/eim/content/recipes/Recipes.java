...
public class Recipes {
	...
	public static void initRecipes(){
		...
		GameRegistry.addRecipe(new ItemStack(EIMBlocks.dualCraftingTable), new Object[] {"XPX", "III", "XPX", 'X', Blocks.crafting_table, 'I', Items.iron_ingot, 'P', Blocks.planks});
	}
